package com.suiplz.blog.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.JsonMappingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.suiplz.blog.config.auth.PrincipalDetail;
import com.suiplz.blog.model.KakaoProfile;
import com.suiplz.blog.model.OAuthToken;
...
public class UserController {
    ...
    public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
        ...
        params.add("client_id",  "4f1761ca2e6f8dcee21d18d6ea17a168");
        ...
        // Http 요청하기 Post방식으로 , responser 변수의 응답 받음음
